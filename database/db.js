...
let MainMovieScheme = new Schema({
    name: { type: String },
    image: { type: String },
    Duration: { type: String },
    category: { type: String },
...
clickScheme.plugin(autoI, { field: 'clickId' });
clickScheme.plugin(paginate);
let Click = mongoose.model('click', clickScheme);
...
MainMovieScheme.plugin(autoI, { field: 'mainmovieId' });
MainMovieScheme.plugin(paginate);
let MainMovie = mongoose.model('Mainmovie', MainMovieScheme);
